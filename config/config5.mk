...
ENABLE_PRAY = 1  # 0: disable, 1: enable. Use PRAY for ray tracing.

EXTRA_FLAGS = -DVERSION="5.0" -DENABLE_OMP -fopenmp -DENABLE_BVH -DENABLE_SIMD -DENABLE_MPOOL -DENABLE_PRAY